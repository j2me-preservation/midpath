...
public class SDLTrueTypeFont {
	...
	SDL_Surface surface = SWIG_SDLTTF.TTF_RenderText_Solid_FAST(swigTTFFont, text, (short)fg.getRed(), (short)fg.getGreen(), (short)fg.getBlue());
	...
	SDL_Surface surface = SWIG_SDLTTF.TTF_RenderText_Shaded_FAST(swigTTFFont, text, (short)fg.getRed(), (short)fg.getGreen(), (short)fg.getBlue(), (short)bg.getRed(), (short)bg.getGreen(), (short)bg.getBlue());
	return new SDLSurface(surface);
    }
	...
	SDL_Surface surface = SWIG_SDLTTF.TTF_RenderText_Blended_FAST(swigTTFFont, text, (short)fg.getRed(), (short)fg.getGreen(), (short)fg.getBlue());
	return new SDLSurface(surface);
    }
	...
	if(size == null) size = new TextSize();
	...
	buf.append("SDLTrueTypeFont[path=").append(getPath()).
	    append(", ptsize=").append(getPTSize()).
	    append(", style=").append(getFontStyle()).
	    append(", height=").append(fontHeight()).
	    append(", ascent=").append(fontAscent()).
	    append(", descent=").append(fontDescent()).
	    append(", lineSkip=").append(fontLineSkip()).
	    append("]");
