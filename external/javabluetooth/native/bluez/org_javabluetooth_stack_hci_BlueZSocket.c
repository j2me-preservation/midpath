...
extern "C" {
 ...
 /* Handle for the Bluetooth socket */ 
int sock;          
 ...
 * Signature: ()I
 */
JNIEXPORT jint JNICALL Java_org_javabluetooth_stack_hci_BlueZSocket_available0(JNIEnv * env, jobject obj) {
 ...
 * Signature: ([BII)I
 */
JNIEXPORT jint JNICALL Java_org_javabluetooth_stack_hci_BlueZSocket_write0(JNIEnv * env, jobject obj, jbyteArray byteBuffer, jint offset, jint length) {
 ...
 * Signature: ()V
 */
JNIEXPORT void JNICALL Java_org_javabluetooth_stack_hci_BlueZSocket_close0(JNIEnv * env, jobject obj) {
	snd_pcm_drain(pcm_handle);
}
