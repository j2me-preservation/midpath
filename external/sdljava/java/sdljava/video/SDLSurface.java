...
//    }
	...
	if (colors.length != 256) throw new SDLException("size of colors array must be 256!");
...
//
	...
	int result = SWIG_SDLVideo.SWIG_SDL_FillRect_FAST(swigSurface, (int)dstrect.getX(), (int)dstrect.getY(), (int)dstrect.getWidth(), (int)dstrect.getHeight(), color);
	if (result == -1) {
	    throw new SDLException(SDLMain.getError());
	}
    }
...
//    }
	...
	try {
	    if(swigSurface != null) freeSurface();
