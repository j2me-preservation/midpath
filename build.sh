...
make jar JAVAC=$JAVAC_CMD JAR_FILE="sdljava-j2se.jar" JAVAC_FLAGS="-bootclasspath $GNU_CLASSPATH_PATH"
...
make jar JAVAC=$JAVAC_CMD JAR_FILE="sdljava-cldc.jar" JAVAC_FLAGS="-bootclasspath $CLDC_PATH:$GNU_CLASSPATH_PATH -source 1.3 -target 1.1"
...
make jar JAVAC=$JAVAC_CMD JAR_FILE="escher-x11-cldc.jar" JAVAC_FLAGS="-bootclasspath $CLDC_PATH -source 1.3 -target 1.1"
...
make jar JAVAC=$JAVAC_CMD JAR_FILE="midpath.jar" JAVAC_FLAGS="-bootclasspath $CLDC_PATH:$GNU_CLASSPATH_PATH:$DIST_HOME/dist/sdljava-cldc.jar:$DIST_HOME/dist/escher-x11-cldc.jar:$DIST_HOME/lib/kxml2-2.3.0.jar:$DIST_HOME/lib/swt.jar -source 1.3 -target 1.1"
