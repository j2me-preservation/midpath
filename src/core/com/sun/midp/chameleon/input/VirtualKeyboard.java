...
//		case KEY_PAGE_DOWN_LARGE: inputCharacter=KEY_PAGE_DOWN; break;
	...
	private final static int KEY_MAP_ACCENTS_LOWER[][]={
		{ KEY_ABC, 0, 0 }, { '`', 16, 0 }, { 0xb4, 32, 0 }, { '^', 48, 0 }, { '¨', 64, 0 }, { '~', 80, 0 }, { '°', 96, 0 }, { 0xaf, 112, 0 }, { 0xb8, 128, 0}, { 0xe0, 144, 0 }, { 0xe1, 160, 0 },
	...
	private final static int KEY_MAP_ACCENTS_UPPER[][]={
		{ KEY_ABC, 0, 0 }, { '`', 16, 0 }, { 0xb4, 32, 0 }, { '^', 48, 0 }, { '¨', 64, 0 }, { '~', 80, 0 }, { '°', 96, 0 }, { 0xaf, 112, 0 }, { 0xb8, 128, 0}, { 0xc0, 144, 0 }, { 0xc1, 160, 0 }, 
	...
	private final static int KEY_MAP_SYMBOLS[][]={
		...
		{ KEY_SYMBOLS, 0, 32 }, { 0xa4, 16, 32 }, { '$', 32, 32 }, { 0xa2, 48, 32 }, { '£', 64, 32 }, { 0xa5, 80, 32 }, { 0x20ac, 96, 32 }, { 0xb7, 112, 32 }, { '{', 128, 32 }, { '}', 144, 32 }, { '\'', 160, 32 },
