 ...
 */
public class AWTEventPump implements Runnable {
	...
	public void processEvent(SDLKeyboardEvent event) {
		...
		if (unicode != 0) {
			...
			int code = AWTEventMapper.mapToInternalEvent(keyCode);
			if (code == keyCode) {
		...
		nativeEvent.intParam2 = AWTEventMapper.mapToInternalEvent(keyCode);
