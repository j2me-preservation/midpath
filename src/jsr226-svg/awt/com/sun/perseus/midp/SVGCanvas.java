...
class SVGCanvas extends AbstractSVGCanvas {
	...
	protected Canvas awtCanvas;
	
	private static final Color CLEAR_COLOR_AWT = new Color(CLEAR_COLOR);
	...
	protected void repaintNative(int x, int y, int width, int height) {
		awtCanvas.repaint(x, y, width, height);
	}
