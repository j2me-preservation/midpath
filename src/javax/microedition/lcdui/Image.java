...
public class Image {
	...
	public static Image createImage(Image image, int x, int y, int width, int height, int transform) {
		...
		if (x < 0 || y < 0 || (x + width) > image.getWidth() || // throws NPE if image is null
	 ...
	 */
	static Image getRomizedImage(int imageDataArrayPtr, int imageDataArrayLength) {
	...
	//     *                  create new Image
	//     */
	//    protected Image(ImageData imageData) {
