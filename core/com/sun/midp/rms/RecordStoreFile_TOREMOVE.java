 ...
 */
class RecordStoreFile_TOREMOVE implements AbstractRecordStoreFile {
     ...
     */
    static String[] listRecordStores(String suiteID) {
     ...
     */
    private static native int getNumberOfStores(String id);
     ...
     */
    private static native void getRecordStoreList(String id, String[] names);
     ...
     * @param id ID of the suite
     */
    static native void removeRecordStores(String id);
     ...
     */
    static native int spaceAvailableNewRecordStore(String suiteID);
     ...
     */
    RecordStoreFile_TOREMOVE(String suiteID, String name,
     ...
     * @exception IOException if there is an error opening the file.
     */
    private native int openRecordStoreFile(String suiteID,
                                           String name,
                                           int extension) throws IOException;
