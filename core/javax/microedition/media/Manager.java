...
import org.thenesis.midpath.mmedia.SDLMusicPlayer;
import org.thenesis.midpath.mmedia.SDLWavPlayer;
...
public final class Manager {
    ...
    public static Player createPlayer(InputStream stream, String type)
        ...
        if (type.equalsIgnoreCase("audio/x-wav")) {
        	return new SDLWavPlayer(stream, type);
        } else {
        	return new SDLMusicPlayer(stream, type);
        }
...
//            // Try and instance the player ....
//            Class protoClass = Class.forName(className);
//            player  = (Player) protoClass.newInstance();
//        } catch (Exception e) {
//        	e.printStackTrace();
//        	throw new MediaException("Not supported");
//        }
