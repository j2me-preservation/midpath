...
#include "org_thenesis_midpath_ui_backend_qt_QTCanvas.h"
...
void CustomCanvas::keyPressEvent(QKeyEvent *e) {
    ...
    env->CallVoidMethod(javaQtCanvasObject, callback, 1, convertKey(e->key()), (int)(e->text().unicode()->unicode()));
...
void CustomCanvas::keyReleaseEvent(QKeyEvent *e) {
    ...
    env->CallVoidMethod(javaQtCanvasObject, callback, 0, convertKey(e->key()), (int)(e->text().unicode()->unicode()));
